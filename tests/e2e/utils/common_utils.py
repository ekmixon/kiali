...
class common_utils():
    ...
    def get_pod_id(self, namespace=None, pod_name=None):
        try:
            response = common_utils.get_response(
                self,
                method_name='workloadDetails',
    ...
    def get_response(self, method_name=None, path=None, params=None, data=None, status_code_expected=200, http_method='GET'):
